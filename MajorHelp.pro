...
DISTFILES += \
    res/StanfordAeronauticsAndAstronauticsCourseList.txt \
    res/StanfordBioengineeringCourseList.txt \
    res/StanfordChemicalEngineeringCourseList.txt \
    res/StanfordCivilAndEnvironmentalEngineeringCourseList.txt \
    res/StanfordComputationalAndMathematicalEngineeringCourseList.txt \
    res/StanfordCourseList.txt \
    res/StanfordDesignInstituteCourseList.txt \
    res/StanfordElectricalEngineeringCourseList.txt \
    res/StanfordEngineeringCourseList.txt \
    res/StanfordManagementScienceAndEngineeringCourseList.txt \
    res/StanfordMaterialsScienceAndEngineeringCourseList.txt \
    res/StanfordMechanicalEngineeringCourseList.txt \
    res/StanfordPhilosophyCourseList.txt \
    res/StanfordScientificComputingAndComputationalMathCourseList.txt \
    res/StanfordSymbolicSystemCourseList.txt
